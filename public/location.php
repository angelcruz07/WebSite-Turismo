...
<body class="scroll-top">
  <div class="container-front-page">
    ...
    <img src="../admin/assets/imgLocation/front-page.jpg" alt="Portada de Ubicacion" title="Ubicacion" class="image-front-page">
  </div>
  <h2 class="title-index">Ubicacion Geográfica</h2>
  <div class="container-btn">
    <div class="show-map-btn">
      <a href="./gastronomy.php">Sabor Local: Mejores Restaurantes y Cafeterías en Sultepec</a>
    </div>
    <div class="show-map-btn">
      <a href="./services.php">Cómo Llegar a Sultepec Consejos de Transporte </a>
    </div>
    <div class="show-map-btn">
      <a href="./lodging.php"> Hoteles y Alojamientos en Sultepec</a>
    </div>
  </div>
