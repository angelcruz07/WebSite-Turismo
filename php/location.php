...
<section class="ubication" id="location">
  <div class="container-ubication">
    <div class="container-map">
      ...
      <iframe src="https://www.google.com/maps/d/embed?mid=1LwYd4jbEay2rivpSh2MEulo-UltvtNg&ehbc=2E312F" width="540"
        height="480"></iframe>
        <div class="container-location">
    <p class="location-text">Sultepec de Pedro Ascencio de Alquisiras, ubicado al sur del estado de México, es una joya
