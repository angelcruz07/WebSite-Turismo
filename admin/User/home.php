...
if (
  ...
  $sql = "INSERT INTO request(business_type, business, business_image, description, product_type, product_image, name, adress, phone_number) 
          VALUES ('$business_type', '$name_business', '$business_image', '$description', '$product_type', '$product_image', '$name', '$adress', '$phone')"; 
